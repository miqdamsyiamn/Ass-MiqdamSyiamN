    ...
    <div class="content">
      <section id="home">
        ...
        <div class="kolom">
          ...
          <br>
          <button onclick="document.getElementById('ganti').src = 'images/logo2.avif'" class="p-3 px-5 bg-sky-700 rounded-md shadow-md shadow-black hover:shadow-lg delay-300 right-0 rounded-xl text-white hover:text-red-400">Ganti Gambar</button>
        </div>
      </section>
    </div>
    <!-- content end -->
